...
sudo chmod 664 feeds/xiaoqingfeng/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
...
echo "sed -i 's/\/bin\/ash/\/usr\/bin\/zsh/g' /etc/passwd" >> package/lean/default-settings/files/zzz-default-settings
